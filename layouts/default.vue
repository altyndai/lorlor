...
<template>
  <div>
    <!-- header   -->
    <header>
      <div class="line-box w-full border-bottom-1 border-300 z-100">
        <div class="container">
            <div class="flex justify-content-between align-items-center bg-white">
              <Menubar :model="items" class="bg-transparents"/>
              ...
              <div class="flex align-items-center ">
                ...
                />
                <div class="line" />
                <a href="tel:8(495)266-28-74" class="ml-4 text-pink-500 font-medium text-xl">8 (495) 266-28-74</a>
              </div>
            </div>
        </div>
      </div>
      <div>
        <div class="container">
          <div class="grid justify-content-center">
            <div class="col-12 md:col-4 lg:col-3 mb-5 mt-4">
              <div class="branch">
                <img class="logo" src="https://lorlor.ru/content/images/logo.svg" alt="">
              </div>
            </div>
            <div class="col-12 md:col-4 lg:col-3 mb-5 mt-4">
              <div class="branch">
                ...
                <div class="branch-info">
                  ...
                  <Tag class="branch__tag" value="Круглосуточно" />
                </div>
              </div>
            </div>
            <div class="col-12 md:col-4 lg:col-3 mb-5 mt-4">
            ...
            <div class="col-12 md:col-4 lg:col-3 mb-5">
              <div class="branch">
            ...
            <div class="col-12 md:col-4 lg:col-3 mb-5 ">
              <div class="branch">
                <div class="branch-info flex align-items-center">
                  <img class="branch__icon icon" src="https://lorlor.ru/content/images/icons/sun.svg" alt="">
                  <div class="flex align-items-center">
                    <p>Г. Сочи</p>
                    <Tag value="скоро" class="border-round-sm py-0 px-2 mb-5 ml-2" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <slot />
    <!--  footer  -->
    <footer class="bg-[#364779] pt-8 pb-7">
      <div class="container">
          ...
          <div class="col-12 lg:col-3">
            <div class="flex justify-content-center ">
              <div class="grid--branch-footer relative grid sm:justify-content-center my-5 flex-column">
                ...
                <div class="col-12">
                  <div class="branch branch--white-text flex">
                    <div class="mr-3">
                      <img src="/img/sun.svg" alt="sun" class="w-2rem">
                    </div>
                    <div>
                      <div class="flex align-items-center">
                        <h3 class="branch__title text-white">
                          г. Сочи
                        </h3>
                        <Tag value="cкоро" class="text-sm font-normal p-tag-danger ml-2 -mt-4" />
                      </div>
                      <p class="branch__subtitle text-white mb-1">
                        Навагинская, 7
                      </p>
                      <p class="branch__subtitle text-white">
      ...
      <div class="bg-[#465B9C] w-full py-6">
